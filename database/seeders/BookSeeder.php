...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      //   $book = new Book ();
      //   $book->title = rand(1, 100) . "Beginning JavaScript, 3rd Edition";
      //   $book->author = rand(1, 100) . "Ethan Brown";
      //   $book->phone = '0' . $this->random_str(2, '0123456789') . '-' . $this->random_str(7, '0123456789');
      //   $book->author = rand(1, 100) . 26;
      //   $book->author = rand(2000, 3000) . 2017;
